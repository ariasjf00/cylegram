                ...
                @if ($user->id !== auth()->user()->id)
                  @if (!$user->siguiendo( auth()->user() ))
                    ...
                    >
                      ...
                      <input 
                        type="submit"
                        class="bg-blue-500 text-xs text-white uppercase rounded-lg px-3 py-1 font-bold cursor-pointer" 
                        value="Seguir"                  
                      />
                    </form>
                  @else  
                    ...
                    >
                      ...
                      <input 
                        type="submit"
                        class="bg-red-500 text-xs text-white uppercase rounded-lg px-3 py-1 font-bold cursor-pointer" 
